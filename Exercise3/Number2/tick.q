...
// upd:{[t;x]
// if[not -16=type first x;if[d<"d"$a:.z.P;.z.ts[]];a:"n"$a;x:$[0>type first x;a,x;(enlist(count first x)#a),x]];
...
if[not system"t";system"t 1000";
 ...
 .test1.t:t;
 .test1.d:x;
 if[not -16=type first x; x[0]:"N"$(string first x)];
 //if[not -16=type first x;a:"n"$a;x:$[0>type first x;a,x;(enlist(count first x)#a),x]];
 .test1.x:x;
